function net = vgg16_intialization_down4(warpsize,cdim,ndim, RoIRoD)

net = load('data/pretrained_models/imagenet-vgg-verydeep-16.mat');
net = vl_simplenn_tidy(net);
net.layers = net.layers(1:26);

% Convert to DagNN.
net = dagnn.DagNN.fromSimpleNN(net, 'canonicalNames', true) ;  

% Dimension reduction
net.addLayer('dimred', convBlocknoPad(1,1,512,cdim), {'x26'}, {'xRed'}, {'dimred_filter','dimred_bias'});
